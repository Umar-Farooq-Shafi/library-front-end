      ...
      {numSelected > 0 ? (
        ...
        <>
          <Button
            ...
            onClick={
              title === 'Book' ? handleClickOpenBook : handleClickOpenStudent
            }>
            Add
          </Button>
...
export default function EnhancedTable({ title, rows, headCells }: any) {
  const [order, setOrder] = React.useState<Order>('asc');
  const [orderBy, setOrderBy] = React.useState('book_name');
                    ...
                    <TableRow
                      ...
                      {title === 'Book' ? (
                        <>
                          ...
                          <TableCell align='left'>{row.issue_date}</TableCell>
